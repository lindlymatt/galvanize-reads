    ...
    .then(function () {
      return Promise.all([
        ...
        knex('authors').insert({
          ...
          portal_url: 'https://s3-us-west-2.amazonaws.com/assessment-images/galvanize_reads/photos/alex_martelli.jpg'
        }),
        knex('authors').insert({
          first_name: 'Allen B.',
          last_name: 'Downey',
          ...
          portal_url: 'https://s3-us-west-2.amazonaws.com/assessment-images/galvanize_reads/photos/allen_downey.jpg'
        }),
        knex('authors').insert({
          first_name: 'Bonnie',
          last_name: 'Eisenman',
          ...
          portal_url: 'https://s3-us-west-2.amazonaws.com/assessment-images/galvanize_reads/photos/bonnie_eisenman.jp'
        }),
        knex('authors').insert({
          first_name: 'Kyle',
          last_name: 'Simpson',
          ...
          portal_url: 'https://s3-us-west-2.amazonaws.com/assessment-images/galvanize_reads/photos/kyle_simpson.jpg'
        }),
        knex('authors').insert({
          first_name: 'Anna',
          last_name: 'Ravenscoft',
          ...
          portal_url: 'https://s3-us-west-2.amazonaws.com/assessment-images/galvanize_reads/photos/anna_ravenscroft.jpg'
        }),
        knex('authors').insert({
          first_name: 'Steve',
          last_name: 'Holden',
          ...
          portal_url: 'https://s3-us-west-2.amazonaws.com/assessment-images/galvanize_reads/photos/steve_holden.jpg'
        })
      ]);
    });
};
